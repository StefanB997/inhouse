...
if($currentrole == 'user') {
    echo "<script> alert('Only admins can add user');
    ...
    if(isset($_POST['add'])) {
        ...
        $gump->validation_rules(array(
            ...
            'lastname' => 'required|alpha|max_len,30|men_len,1',
        ...
        if($validated_data === false) {
            ...
            $query = "INSERT INTO users(username,firstname,lastname,email,password,role,phonenumber) VALUES ('$username' , '$firstname' , '$lastname' , '$email', '$password' , '$role', '$phone')";
